...
export default function MainDashboard() {
  ...
  return (
    <>
      ...
      {/* ── Hero: full-bleed Laguna Beach AI dashboard video, no text/UI overlays ── */}
      <section className="wd-hero" aria-label="CinNova Real Estate AI dashboard">

        <div className="wd-hero-bg" aria-hidden>
          {/* Approved loop-fixed Laguna Beach AI dashboard video — the only hero visual. */}
          <video
            className="wd-hero-video"
            src="/videos/cinnova-real-estate-ai-blog-hero-investment-dashboard.mp4"
            autoPlay
            muted
            loop
            playsInline
            ...
            aria-hidden="true"
          />
          {/* Subtle scrim only — polish + melts the video into the dashboard below. */}
          <div className="wd-hero-scrim" />
        </div>
      </section>

      <div className="page wd-dashboard-page">
      ...
      <div className="wd-main-row">
        ...
        <div className="wd-advisor-panel card">
          ...
          <button className="btn btn-primary" style={{ width: '100%', marginTop: 16 }} onClick={() => go('/ai-advisor-chat')} disabled={isComingSoon('/ai-advisor-chat')}>
            AI Advisor {isComingSoon('/ai-advisor-chat') && <Soon />}
          </button>
        </div>
      </div>
      ...
      <div className="section">
        ...
        <div className="wd-quick-actions">
          ...
          <button className="wd-qa-btn wd-qa-btn--teal" onClick={() => go('/ai-advisor-chat')} disabled={isComingSoon('/ai-advisor-chat')}>
            ...
            <div>
              <div className="wd-qa-label">AI Advisor {isComingSoon('/ai-advisor-chat') && <Soon />}</div>
